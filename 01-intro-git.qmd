...
It seems like you (I did too) wrote an R code which includes randomness but for which we forgot to set seed. Let's correct the error while also version controlling. 
